...
#define GET_SPECIES(NAME) (islist(all_species) ? (all_species[NAME] || all_species[SPECIES_HUMAN]) : null)
...
/datum/category_item/player_setup_item/general/body/sanitize_character(var/savefile/S)
	...
	var/datum/species/mob_species = GET_SPECIES(pref.species)
	if(!mob_species)
		mob_species = new /datum/species/human
...
/datum/category_item/player_setup_item/general/body/content(var/mob/user)
	...
	var/datum/species/mob_species = GET_SPECIES(pref.species) || new /datum/species/human
	...
	if(has_flag(mob_species, HAS_HAIR_COLOR))
		. += "<a href='byond://?src=\ref[src];hair_color=1'>Hair</a> <font face='fixedsys' size='3' color='#[num2hex(pref.r_hair, 2)][num2hex(pref.g_hair, 2)][num2hex(pref.b_hair, 2)]'><table style='display:inline;' bgcolor='#[num2hex(pref.r_hair, 2)][num2hex(pref.g_hair, 2)][num2hex(pref.b_hair)]'><tr><td>__</td></tr></table></font>"
	. += " Style: <a href='byond://?src=\ref[src];hair_style=1'>[pref.h_style]</a><br>"

	if(has_flag(mob_species, HAS_HAIR_COLOR))
		. += "<a href='byond://?src=\ref[src];facial_color=1'>Facial hair</a> <font face='fixedsys' size='3' color='#[num2hex(pref.r_facial, 2)][num2hex(pref.g_facial, 2)][num2hex(pref.b_facial, 2)]'><table  style='display:inline;' bgcolor='#[num2hex(pref.r_facial, 2)][num2hex(pref.g_facial, 2)][num2hex(pref.b_facial)]'><tr><td>__</td></tr></table></font>"
	. += " Style: <a href='byond://?src=\ref[src];facial_style=1'>[pref.f_style]</a><br>"

	if(has_flag(mob_species, HAS_EYE_COLOR))
		. += "<a href='byond://?src=\ref[src];eye_color=1'>Eyes</a> <font face='fixedsys' size='3' color='#[num2hex(pref.r_eyes, 2)][num2hex(pref.g_eyes, 2)][num2hex(pref.b_eyes, 2)]'><table  style='display:inline;' bgcolor='#[num2hex(pref.r_eyes, 2)][num2hex(pref.g_eyes, 2)][num2hex(pref.b_eyes)]'><tr><td>__</td></tr></table></font><br>"

	if(has_flag(mob_species, HAS_SKIN_COLOR))
		. += "<a href='byond://?src=\ref[src];skin_color=1'>Body</a> <font face='fixedsys' size='3' color='#[num2hex(pref.r_skin, 2)][num2hex(pref.g_skin, 2)][num2hex(pref.b_skin, 2)]'><table style='display:inline;' bgcolor='#[num2hex(pref.r_skin, 2)][num2hex(pref.g_skin, 2)][num2hex(pref.b_skin)]'><tr><td>__</td></tr></table></font><br>"
...
/datum/category_item/player_setup_item/general/body/OnTopic(var/href,var/list/href_list, var/mob/user)
	...
	if(href_list["random"])
		...
		if(prev_species != pref.species)
			mob_species = GET_SPECIES(pref.species) || new /datum/species/human
		...
		var/datum/species/current_species = GET_SPECIES(pref.species) || new /datum/species/human
